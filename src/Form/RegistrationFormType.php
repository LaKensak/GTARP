 ...
 * Contient tous les champs demandés dans le cahier des charges
 */
class RegistrationFormType extends AbstractType
{
    ...
    {
        // Génération de deux nombres aléatoires pour le captcha
        $session = $this->requestStack->getSession();

        // On génère les nombres seulement si pas déjà en session (pour garder les mêmes après erreur)
        ...
        $builder
            // Email obligatoire - utilisé pour la connexion
            ...
            // Mot de passe avec double vérification (RepeatedType)
            ->add('plainPassword', RepeatedType::class, [
                ...
                'constraints' => [
                    ...
                    new Length([
                        ...
                        'max' => 4096, // limite Symfony pour éviter les attaques
                    ]),
                ],
            ])
            // Pseudo obligatoire
            ...
            // Ville avec auto-complétion (géré côté JS)
            ->add('ville', TextType::class, [
                'label' => 'Ville',
                'required' => false,
                'attr' => [
                    'placeholder' => 'Votre ville (optionnel)',
                    'class' => 'ville-autocomplete', // pour le JS
                ],
            ])
